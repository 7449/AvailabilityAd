...
import com.github.availability.ad.branch.admob.databinding.LayoutAdmobNativeAdBinding
...
internal class NativeAdView @JvmOverloads constructor(
    ...
    private val viewBinding =
        LayoutAdmobNativeAdBinding.inflate(LayoutInflater.from(getContext()), this, true)
    private val adView get() = viewBinding.nativeView
